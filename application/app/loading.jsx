export default function Loading() {
  return (
    <main className="page-shell mx-auto w-full max-w-7xl px-4 py-8 sm:px-5 lg:px-6" aria-live="polite" aria-busy="true">
      ...
      <div className="mt-7 grid gap-4 lg:grid-cols-3">
        {[0, 1, 2].map((item) => (
          <div key={item} className="surface-card h-40 animate-pulse" />
        ))}
      </div>
