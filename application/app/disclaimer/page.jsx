...
export const metadata = {
  ...
  description: "Understand how CAP Predictor uses historical Maharashtra engineering cutoff data and why predictions cannot guarantee admission.",
    ...
    <>
      ...
      <main className="mx-auto w-full max-w-4xl px-4 py-10">
        ...
        <div className="mt-8 grid gap-7 text-sm leading-7 text-slate-700">
          <p>CAP Predictor compares a student&apos;s score and eligible seat types with verified historical FE or DSE CAP cutoff records. It does not search PDFs during prediction and it does not predict the decisions of the CET Cell, colleges or other applicants.</p>
