    ...
    <>
      ...
      <main className="mx-auto w-full max-w-4xl px-4 py-10">
        ...
        <div className="mt-8 grid gap-8 text-sm leading-7 text-slate-700">
          <section><h2 className="text-xl font-semibold text-ink">Educational decision support</h2><p className="mt-2">CAP Predictor is an independent research tool. It is not operated, endorsed or approved by the Maharashtra State Common Entrance Test Cell or any college, university or government authority.</p></section>
