...
\copy cutoffs (id, dataset_id, college_branch_id, seat_type_id, stage, section, opening_rank, closing_rank, opening_score, closing_score, source_page, verified, needs_review, review_reason) FROM 'data/processed/postgres/cutoffs.csv' WITH (FORMAT csv, HEADER true);
